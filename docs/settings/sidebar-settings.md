...
> These settings can be combined with sidebery.autohide. Learn more about this in the [Sidebery Configuration docs ->](/docs/configurations/sidebery)
...
Learn more about this in the [Sidebery Configuration docs ->](/docs/configurations/sidebery)
