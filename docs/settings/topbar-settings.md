...
<img width="98%" alt="preview" src="https://github.com/user-attachments/assets/be397407-ecc0-43f5-bfbe-821777605f13" />
...
<img width="98%" alt="preview" src="/img/settings/navbarfloatfullsize.png" />

### ultima.navbar.autohide.ignore.urlbar

When combined with `navbar.autohide` or `navbar.float`, triggering the url bar (with <kbd>ctrl+L</kbd> or clicking) will not trigger the navbar to show.

This setting wont not prevent the navbar from showing when you hover over the url bar popout.

<img width="98%" alt="preview" src="/img/settings/navbarautohideignoreurlbarr.gif" />

### ultima.navbar.hide.buttons

Hide the buttons on the navigation bar when not hovered. When panels like the menu, extensions, or downloads are triggered/focused/downloading those specific buttons will remain visible until not focused
